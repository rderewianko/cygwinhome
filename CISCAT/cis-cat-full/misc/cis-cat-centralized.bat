...
::
:: Centralized CIS-CAT Wrapper v2.0.6
::
...
SET NetworkShare=\\127.0.0.1\CIS
...
ECHO.
ECHO Centralized CIS-CAT Wrapper v2.0.6 
...
SET Benchmark=CIS_Microsoft_Windows_7_Benchmark_v2.1.0-xccdf.xml
...
SET Benchmark=CIS_Microsoft_Windows_Server_2008_R2_Benchmark_v2.1.0-xccdf.xml
...
SET Benchmark=CIS_Microsoft_Windows_Server_2008_Benchmark_v2.1.0-xccdf.xml
...
SET Benchmark=CIS_Microsoft_Windows_Server_2012_Benchmark_v1.0.0-xccdf.xml
...
ECHO  + Running %Benchmark%/%%P...
ECHO.
ECHO [[ CIS-CAT OUTPUT START ]]
IF %DEBUG%==1 ECHO CMDLINE = %mJavaPath%\bin\java.exe -Xmx512M -jar  %mCisCatPath%\CISCAT.jar -a -s -x -b %mCisCatPath%\benchmarks\%Benchmark% -p "%%P" -r "%mReportsPath%" >> %DebugLogFile%
%mJavaPath%\bin\java.exe -Xmx512M -jar  %mCisCatPath%\CISCAT.jar -a -s -x -b %mCisCatPath%\benchmarks\%Benchmark% -p "%%P" -r "%mReportsPath%" 
